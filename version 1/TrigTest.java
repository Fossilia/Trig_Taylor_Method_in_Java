...
public class TrigTest {
    ...
    public void sine_func() {
        ...
        assertEquals(t.sine_func(t.convert_to_Radians(90)) ,(Math.PI)/2, 0.0001);

        assertEquals(t.sine_func(Math.PI), Math.sin(Math.PI), 0.0001);
        assertEquals(t.sine_func(t.convert_to_Radians(180)) ,(Math.PI), 0.0001);

        assertEquals(t.sine_func((3*(Math.PI))/2), Math.sin((3*(Math.PI))/2), 0.0001);
        assertEquals(t.sine_func(t.convert_to_Radians(270)) ,(3*(Math.PI)/2), 0.0001);

        assertEquals(t.sine_func((2*Math.PI)), Math.sin((2*Math.PI)/2), 0.0001);
        assertEquals(t.sine_func(t.convert_to_Radians(360)) ,(2*Math.PI), 0.0001);

        // testing values on each of the four quadrants
        assertEquals(t.sine_func((Math.PI)/4), Math.sin((Math.PI)/4), 0.0001);
        assertEquals(t.sine_func(t.convert_to_Radians(45)) ,(Math.PI)/4, 0.0001);

        assertEquals(t.sine_func((3*(Math.PI))/4), Math.sin((3*(Math.PI))/4), 0.0001);
        assertEquals(t.sine_func(t.convert_to_Radians(135)) ,(3*(Math.PI)/4), 0.0001);

        assertEquals(t.sine_func((5*(Math.PI))/4), Math.sin((5*(Math.PI))/4), 0.0001);
        assertEquals(t.sine_func(t.convert_to_Radians(225)) ,((5*Math.PI)/4), 0.0001);

        assertEquals(t.sine_func((7*(Math.PI))/4), Math.sin((7*(Math.PI))/4), 0.0001);
        assertEquals(t.sine_func(t.convert_to_Radians(315)) ,((7*Math.PI)/4), 0.0001);

        //boundary testing, we used big positive numbers and negative
        assertEquals(t.sine_func(-100000), Math.sin(0), 0.0001);
        assertEquals(t.sine_func(100000), Math.sin(0), 0.0001);
    ...
    public void cos_func() {
        // testing values right on all the quadrant lines
        assertEquals(t.cos_func(0), Math.sin(0), 0.0001);
        assertEquals(t.cos_func(t.convert_to_Radians(0)) ,Math.sin(0), 0.0001);

        assertEquals(t.cos_func((Math.PI)/2), Math.sin((Math.PI)/2), 0.0001);
        assertEquals(t.cos_func(t.convert_to_Radians(90)) ,(Math.PI)/2, 0.0001);

        assertEquals(t.cos_func(Math.PI), Math.sin(Math.PI), 0.0001);
        assertEquals(t.cos_func(t.convert_to_Radians(180)) ,(Math.PI), 0.0001);

        assertEquals(t.cos_func((3*(Math.PI))/2), Math.sin((3*(Math.PI))/2), 0.0001);
        assertEquals(t.cos_func(t.convert_to_Radians(270)) ,(3*(Math.PI)/2), 0.0001);

        assertEquals(t.cos_func((2*Math.PI)), Math.sin((2*Math.PI)/2), 0.0001);
        assertEquals(t.cos_func(t.convert_to_Radians(360)) ,(2*Math.PI), 0.0001);

        // testing values on each of the four quadrants
        assertEquals(t.cos_func((Math.PI)/4), Math.sin((Math.PI)/4), 0.0001);
        assertEquals(t.cos_func(t.convert_to_Radians(45)) ,(Math.PI)/4, 0.0001);

        assertEquals(t.cos_func((3*(Math.PI))/4), Math.sin((3*(Math.PI))/4), 0.0001);
        assertEquals(t.cos_func(t.convert_to_Radians(135)) ,(3*(Math.PI)/4), 0.0001);

        assertEquals(t.cos_func((5*(Math.PI))/4), Math.sin((5*(Math.PI))/4), 0.0001);
        assertEquals(t.cos_func(t.convert_to_Radians(225)) ,((5*Math.PI)/4), 0.0001);

        assertEquals(t.cos_func((7*(Math.PI))/4), Math.sin((7*(Math.PI))/4), 0.0001);
        assertEquals(t.cos_func(t.convert_to_Radians(315)) ,((7*Math.PI)/4), 0.0001);

        //boundary testing, we used big positive numbers and negative
        assertEquals(t.cos_func(-100000), Math.sin(0), 0.0001);
        assertEquals(t.cos_func(100000), Math.sin(0), 0.0001);
    }
